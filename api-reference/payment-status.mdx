...
description: "Check the current state of a Kulmi Pay payment by invoice ID. Returns the invoice state (PENDING, PROCESSING, COMPLETE, or FAILED) with full invoice details."
---
