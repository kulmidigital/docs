...
description: "Create and manage subscription customers on KulmiPay. Posting with an existing email updates the customer record instead of creating a duplicate."
---
...
<ParamField body="reference" type="string">
  Your internal reference ID for this customer, up to 45 characters. Useful for linking the KulmiPay customer record to your own database.
</ParamField>
