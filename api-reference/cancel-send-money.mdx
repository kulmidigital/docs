...
sidebarTitle: "Cancel payout"
description: "Cancel a disbursement payment file before it is processed, preventing any transactions from being sent to recipients. Requires the file_id from initiation."
---
