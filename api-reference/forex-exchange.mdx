...
description: "Get a live FX rate quote between two KulmiPay settlement wallets in different currencies, then execute the exchange to move funds at that rate."
---
