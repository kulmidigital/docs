---
title: "POST /api/v1/send-money/initiate"
sidebarTitle: "Initiate send money"
description: "Create a send money payment file with one or more transactions to M-Pesa wallets, M-Pesa Till or PayBill numbers, bank accounts, or KulmiPay wallets."
---
...
**`POST https://app.kulmipay.com/api/v1/send-money/initiate/`**
...
<ParamField body="provider" type="string" required>
  The payment provider to route the Send Money request through. One of:
...
<ParamField body="transactions" type="array" required>
  ...
  <Expandable title="Transaction object fields">
    ...
    <ParamField body="name" type="string">
      The recipient's display name. Used for record-keeping and visible in your Kulmi Pay dashboard.
    </ParamField>
    ...
    <ParamField body="account_type" type="string">
      For `MPESA-B2B` transactions, specifies how to treat the account. One of `"PayBill"` or `"TillNumber"`.
    </ParamField>
