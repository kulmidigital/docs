---
title: "KulmiPay: Accept Payments and Send Money in Africa"
description: "KulmiPay is a REST API for African businesses — collect M-Pesa, card, and bank payments, and disburse money to mobile wallets and bank accounts."
---

KulmiPay is a payment platform built for businesses operating in Africa. With a single API integration you can accept payments from customers, send money to mobile wallets and bank accounts, manage multi-currency balances, and receive real-time transaction notifications — all without stitching together multiple providers.

## What you can do with KulmiPay
...
KulmiPay notifies your server of transaction outcomes via webhooks, so your application can update records and trigger downstream actions without polling for status.
