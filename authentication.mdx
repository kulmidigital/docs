...
description: "Kulmi Pay uses OAuth2 Bearer tokens for most API calls and a Public Key for checkout and collection requests. Learn how to generate and use both."
---
