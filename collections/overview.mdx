...
description: "Accept M-Pesa, Visa, Mastercard, Apple Pay, Google Pay, and PesaLink payments from customers using a single Kulmi Pay REST API endpoint. Choose who pays the fee."
---
